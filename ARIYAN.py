...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    HRIDOYE = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if HRIDOYE == 'A':
        HRIDOYE()
    if HRIDOYE == 'B':
        ...
        return None
    if HRIDOYE == 'C':
        os.system('xdg-open https://facebook.com/groups/5342216015863750/')
        return None
    if HRIDOYE == 'D':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100090089870896')
        return None
    if HRIDOYE == 'E':
        os.system('exit')
        return None
...
\033[1;96m /$$   /$$ /$$$$$$$  /$$$$$$ /$$$$$$$   /$$$$$$  /$$     /$$ /$$$$$$$$
\033[1;96m| $$  | $$| $$__  $$|_  $$_/| $$__  $$ /$$__  $$|  $$   /$$/| $$_____/
\033[1;96m| $$  | $$| $$  \ $$  | $$  | $$  \ $$| $$  \ $$ \  $$ /$$/ | $$      
\033[1;96m| $$$$$$$$| $$$$$$$/  | $$  | $$  | $$| $$  | $$  \  $$$$/  | $$$$$   
\033[1;96m| $$__  $$| $$__  $$  | $$  | $$  | $$| $$  | $$   \  $$/   | $$__/   
\033[1;96m| $$  | $$| $$  \ $$  | $$  | $$  | $$| $$  | $$    | $$    | $$      
\033[1;96m| $$  | $$| $$  | $$ /$$$$$$| $$$$$$$/|  $$$$$$/    | $$    | $$$$$$$$
\033[1;96m|__/  |__/|__/  |__/|______/|_______/  \______/     |__/    |________/
 


\033[1;96m
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m AUTHOR  \033[1;96m : \033[1;96mARIYAN HRIDOYE
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m FACEBOOK\033[1;96m : \033[1;96mARIYAN HRIDOYE
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m GITHUB  \033[1;96m : \033[1;96mariyan5140
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :HRIDOYE = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :HRIDOYE = ' ~> 2009'
        elif uid[:8] in ['10000000']        :HRIDOYE = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:HRIDOYE = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:HRIDOYE = ' 2010'
        elif uid[:6] in ['100001']          :HRIDOYE = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :HRIDOYE = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :HRIDOYE = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :HRIDOYE = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :HRIDOYE = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :HRIDOYE = ' ~> 2015'
        elif uid[:5] in ['10001']           :HRIDOYE = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :HRIDOYE = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :HRIDOYE = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :HRIDOYE = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :HRIDOYE = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:HRIDOYE = ' ~> 2021'
        elif uid[:5] in ['10008']           :HRIDOYE = ' ~>2022'
        elif uid[:5] in ['10009']           :HRIDOYE = ' ~> 2023'
        else:HRIDOYE=''
